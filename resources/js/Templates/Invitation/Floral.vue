...
<template>
    <div class="gl-pop gl-grain relative w-full max-w-md overflow-hidden rounded-[2rem] bg-gradient-to-b from-rose-50 to-pink-100 p-10 text-center shadow-2xl ring-1 ring-rose-200">
        <!-- floating botanical corners -->
        <div class="gl-float pointer-events-none absolute -left-6 -top-6 rotate-12 text-7xl opacity-30">🌸</div>
        ...
        <div class="relative">
            ...
            <div class="mx-auto mt-6 flex items-center justify-center gap-2 text-rose-300">
                <span class="h-px w-10 bg-rose-300"></span>🌷<span class="h-px w-10 bg-rose-300"></span>
            </div>
