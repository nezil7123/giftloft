...
<template>
    <div ref="root" class="bg-[#f3f4ee] text-emerald-950">
        ...
        <section v-if="event.venue || venueNote || venuePhoto || travel || stay" class="relative px-6 py-24 sm:px-10">
        ...
        <section class="px-6 py-28 sm:px-10">
            <div data-reveal="zoom" class="gl-grain relative mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] bg-emerald-800 px-8 py-20 text-center text-white">
                ...
                <h3 class="relative font-serif text-4xl sm:text-5xl">Wishlist</h3>
            ...
            <p class="mt-10 text-center font-serif text-sm italic text-emerald-700/60">With love, {{ event.user?.name }} · ComeYay</p>
        </section>
    </div>
</template>
