...
<template>
    <div ref="root" class="gl-grain bg-[#faf6ec] text-[#3a2f1c]">
        ...
        <section class="px-6 py-28 sm:px-10">
            <div v-if="showRegistry" data-reveal="zoom" class="mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] border border-amber-500/25 bg-white/60 px-8 py-20 text-center">
