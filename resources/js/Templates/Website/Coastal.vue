...
<template>
    <div ref="root" class="bg-[#f2f8f9] text-[#1c3a44]">
        ...
        <section class="px-6 py-28 sm:px-10">
            <div v-if="showRegistry" data-reveal="zoom" class="mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-cyan-600 to-sky-700 px-8 py-20 text-center text-white">
            ...
            <p class="mt-10 text-center text-xs uppercase tracking-[0.3em] text-[#5a7a82]">{{ event.user?.name }} · ComeYay</p>
        </section>
    </div>
</template>
