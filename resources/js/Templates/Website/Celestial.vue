...
<template>
    <div ref="root" class="bg-[#080614] text-indigo-50">
        ...
        <section class="px-6 py-28 sm:px-10">
            <div v-if="showRegistry" data-reveal="zoom" class="gl-border-glow relative mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] px-8 py-20 text-center" style="--gl-bg:#0c0a1e">
            ...
            <p class="mt-10 text-center text-xs uppercase tracking-[0.3em] text-indigo-400/60">{{ event.user?.name }} · ComeYay</p>
        </section>
    </div>
</template>
