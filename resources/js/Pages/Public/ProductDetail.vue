            ...
            <div class="mt-5 grid gap-8 lg:grid-cols-2 lg:items-start">
                ...
                <div class="lg:py-4">
                    ...
                    <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                        <button type="button" @click="showPicker = true" class="inline-flex items-center justify-center gap-2 rounded-full bg-indigo-600 px-7 py-3.5 text-sm font-semibold text-white transition hover:bg-indigo-500">
